...
public class InstitutionController {
    ...
    public ResponseEntity<PageDTO<InstitutionDTO>> getAllInstitutions(@RequestParam(defaultValue = "0", name = "page") int page, @RequestParam(defaultValue = "10", name = "size") int size) {
        return ResponseEntity.ok().body(institutionService.getAllInstitutions(page, size));
    }
}
